...
Navi reviews semantic boundaries; it does not supervise implementation. For a
clear task, make routine reversible choices and gather evidence without a gate.
Use one consolidated Check after implementation and relevant verification. Add
one pre-work Brainstorm or Founder call only when its disposition could
materially change the direction, scope, contract, ownership, risk, or external
commitment. Do not open separate reviews per file, phase, repair, or command.
